...
export const InsuranceTable = (props) => {
    ...
    return (
        ...
        {eliminar && <ModalConfirmar id={id} open={eliminar} setOpen={setEliminar} message='seguro'/>}
		...
		<table className="w-full p-6 text-xs text-left text-white whitespace-nowrap">
            ...
            {insurances.map((insurance) => (
                    <tr key={insurance.id}>
                        ...
                        <td className="px-3 py-2"><button onClick={()=>{setEliminar(true);setId(insurance.id)}}> 
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
