...
export const ShowTable = (props) => {
    ...
    return (
        ...
        <Link to={"/admin"}>
            ...
            <h2 className="text-2xl font-semibold leading-tight inline text-center ml-2">Shows</h2>
        </div>
		...
		<table className="w-full p-6 text-xs text-left text-white whitespace-nowrap">
            ...
            {shows.map((show) => (
                    <tr key={show.id}>
                        ...
                        <td className="px-3 py-2"><Link to={'/admin/editar-evento/'+show.id}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                            </svg></Link></td>
                        <td className="px-3 py-2"><button onClick={()=>{handleDelete(show.id)}}> 
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
