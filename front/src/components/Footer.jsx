  ...
  return (
    <footer className="px-4 divide-y bg-[#ffffff] text-gray-900">
      <div className="hidden lg:flex container flex-col justify-between py-6 mx-auto  lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="/quienesSomos">
                  ¿Quienes somos?
                </a>
              </li>
              <li>
                <a rel="noopener noreferrer" href="/contacto">
                  Contacto
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="/hoteles">
                  Hoteles
                </a>
              </li>
              <li>
                <a rel="noopener noreferrer" href="/eventos">
                  Eventos
                </a>
              </li>
              <li>
                <a rel="noopener noreferrer" href="/transportes">
                  Medios de transporte
                </a>
              </li>
              <li>
                <a rel="noopener noreferrer" href="/paquetes">
                  Paquetes
                </a>
              </li>
              <li>
                <a rel="noopener noreferrer" href="/seguros">
                  Seguros de viajes
                </a>
              </li>
            </ul>
      ...
      <div className="py-3 text-sm text-center text-gray-900">
        © 2022 Los Frigolinas. All rights reserved.
      </div>
    </footer>
  );
}
