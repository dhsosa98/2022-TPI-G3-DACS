      ...
      <section class=" flex-grow bg-[#ffffffcc] text-black pb-10">
        <div class="p-4 container flex flex-col items-center mx-auto space-y-6 md:p-8">
          <svg
            ...
            viewBox="0 0 512 512"
            fill="currentColor"
            class="mt-8 w-16 h-16 text-[#00adad]"
          >
          ...
          <p class="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl text-black">
            Somos la empresa de viajes líder
          </p>
          <p class="max-w-2xl text-gray-800 text-justify">
