...
<section class=" bg-[#ffffffcc] text-black h-fit m-16 rounded-md pb-16 ">
	<div class="p-4 container flex flex-col items-center mx-auto space-y-6 md:p-8">
		...
		<p class="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl text-black">Somos la empresa de viajes líder</p>
		<p class="max-w-2xl text-gray-800 text-justify">Fantastic Tour S.A.(FANTUR) es la empresa de viajes líder en Latinoamérica, 
        ofreciendo sus servicios hace más de 18 años en 21 países distintos. 
        FANTUR garantiza los mejores precios en vuelos, hoteles, viajes y mucho más.
        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's s
        tandard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type
        ...
        <p class="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl text-black">Cada año somos responables de:</p>
	</div>
 


	<div class="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 ">
		<div class="flex p-4 space-x-4 ml-8 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100">
		...
		<div class="flex p-4 space-x-4 mr-8 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100">
			<div class="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-[#00adad]">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="h-9 w-9 dark:text-gray-800">
