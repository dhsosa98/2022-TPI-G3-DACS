          ...
          <>
            <div key={travelWay.id} className="w-full md:w-1/2 lg:w-1/4 p-3">
              <div className="bg-white rounded-lg p-5 group relative">
                ...
                <Link  to={`/transportes/${travelWay.id}`} className="px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-[#00adad] hover:bg-[#00adad86]">
                  Mas informacion
                </Link>
                </div>
              </div>
